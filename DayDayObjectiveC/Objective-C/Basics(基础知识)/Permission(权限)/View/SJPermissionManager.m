...
@implementation SJPermissionManager

+ (SJPermissionManager *)shareSJPermissionManager{
    
    static SJPermissionManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [SJPermissionManager new];
    });
    return manager;
...
- (void)showAlertViewWithType:(PermissionMessageType)type{
    ...
    switch (type) {
        ...
        case PermissionMessageTypeNetwork:
            title = [NSString stringWithFormat:@"允许“%@”使用网络?", SJ_APP_NAME];
            break;
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:title message:nil delegate:self cancelButtonTitle:@"设置" otherButtonTitles:@"取消", nil];
