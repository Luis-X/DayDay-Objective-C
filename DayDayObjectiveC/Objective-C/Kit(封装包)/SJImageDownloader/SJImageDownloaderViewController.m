//
//  SJImageDownloaderViewController.m
//  LuisXBook-OC
//
...
@interface SJImageDownloaderViewController ()

@end

@implementation SJImageDownloaderViewController{
...
- (void)initialData{
    _allImageUrlArray = @[@"https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1490094635491&di=d49d4e8079b2b6f50505f4e2b8d9cb19&imgtype=0&src=http%3A%2F%2Fpic6.huitu.com%2Fres%2F20130116%2F84481_20130116142820494200_1.jpg",
...
- (void)createMainSubviews{
    ...
    UIButton *startButton = [LuisXKit buttonAddView:self.view Title:@"批量下载" TitleColor:[UIColor blackColor] Font:[UIFont systemFontOfSize:15] CornerRadius:5 BackgroundColor:[UIColor orangeColor]];
